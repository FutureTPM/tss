...
echo "./create -hp 80000000 -dau -ldaa /app/athens-ldaa/issuer_at.bin mode=weak -kt f -kt p -opr ldaa_priv.bin -opu ldaa_pub.bin -pwdp sto -pwdk ldaa"
./create -hp 80000000 -dau -ldaa /app/athens-ldaa/issuer_at.bin mode=weak -kt f -kt p -opr ldaa_priv.bin -opu ldaa_pub.bin -pwdp sto -pwdk ldaa
...
echo "cp ldaa_join_token.bin /app/athens-ldaa/tpm_link_token.bin"
cp ldaa_join_token.bin /app/athens-ldaa/tpm_link_token.bin
echo "cp ldaa_ut.bin /app/athens-ldaa/tpm_public_key.bin"
cp ldaa_ut.bin /app/athens-ldaa/tpm_public_key.bin
...
echo "cp ldaa_nym.bin /app/athens-ldaa/tpm_sign_link_token.bin"
cp ldaa_nym.bin /app/athens-ldaa/tpm_sign_link_token.bin
echo "cp ldaa_pbsn.bin /app/athens-ldaa/tpm_pbsn.bin"
cp ldaa_pbsn.bin /app/athens-ldaa/tpm_pbsn.bin
...
for SIGN in (seq 0 3)
    ...
    echo "./ldaa_signcommit1 -hk 80000001 -sid 0 -bsn basename -seed deadbee1 -sign $SIGN -iatntt /app/athens-ldaa/issuer_at_ntt.bin -ipe ldaa_pe.bin -ipbsn ldaa_pbsn.bin -ocomm $commit1 -pwdk ldaa"
    ./ldaa_signcommit1 -hk 80000001 -sid 0 -bsn basename -seed deadbee1 -sign "$SIGN" -iatntt /app/athens-ldaa/issuer_at_ntt.bin -ipe ldaa_pe.bin -ipbsn ldaa_pbsn.bin -ocomm "$commit1" -pwdk ldaa
    ...
    echo "cp $commit1 /app/athens-ldaa/tpm_comm1_$SIGN.bin"
    cp $commit1 /app/athens-ldaa/tpm_comm1_"$SIGN".bin
    echo "cp $commit2 /app/athens-ldaa/tpm_comm2_$SIGN.bin"
    cp $commit2 /app/athens-ldaa/tpm_comm2_"$SIGN".bin
    echo "cp $commit3 /app/athens-ldaa/tpm_comm3_$SIGN.bin"
    cp $commit3 /app/athens-ldaa/tpm_comm3_"$SIGN".bin
end
...
for SIGN in (seq 0 3)
    ...
    set -l host_r1 /app/athens-ldaa/host_RES"$signT_array[$index]"_1_commit_"$SIGN".bin
    set -l host_r2 /app/athens-ldaa/host_RES"$signT_array[$index]"_2_commit_"$SIGN".bin
    ...
    echo "cp res_1_$SIGN.bin /app/athens-ldaa/res_1_$SIGN.bin"
    echo "cp res_2_$SIGN.bin /app/athens-ldaa/res_2_$SIGN.bin"
    echo "cp sign_group_$SIGN.bin /app/athens-ldaa/sign_group_$SIGN.bin"
    cp res_1_"$SIGN".bin /app/athens-ldaa/res_1_"$SIGN".bin
    cp res_2_"$SIGN".bin /app/athens-ldaa/res_2_"$SIGN".bin
    cp sign_group_"$SIGN".bin /app/athens-ldaa/sign_group_"$SIGN".bin
end
