...
#define LDAA_C1_LENGTH (LDAA_COMMIT1_LENGTH * LDAA_C * LDAA_N)
#define LDAA_C2_LENGTH (LDAA_COMMIT2_LENGTH * LDAA_C * LDAA_N)
#define LDAA_C3_LENGTH (LDAA_COMMIT3_LENGTH * LDAA_C * LDAA_N)
